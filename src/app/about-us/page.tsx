                    ...
                    <div className="w-full justify-start items-center gap-12 grid lg:grid-cols-2 grid-cols-1">
                        <div
                            ...
                            <div
                                ...
                                <img className=" rounded-xl object-cover" src="/images/about-us1.jpg"
                                     alt="about Us image"/>
                            </div>

                            <img className="sm:ml-0 ml-auto rounded-xl object-cover" src="/images/about-us2.jpg"
                                 alt="about Us image"/>
                        </div>
                            ...
                            <div className="w-full flex-col justify-center items-start gap-8 flex">
                                ...
                                <div
                                    ...
                                    <div className="flex-col justify-start items-start inline-flex">
                                        ...
                                        <h6 className="text-secondary text-base font-normal leading-relaxed">Satisfied
                                            Customers</h6>
                                    </div>

                                    <div className="flex-col justify-start items-start inline-flex">
                                        <h4 className="text-primary  text-4xl font-bold font-manrope leading-normal">20%</h4>
                                        <h6 className="text-secondary text-base font-normal leading-relaxed">Average
                                            Savings</h6>
                                    </div>

                                    <div className="flex-col justify-start items-start inline-flex">
                                        <h4 className="text-primary  text-4xl font-bold font-manrope leading-normal">1000+</h4>
                                        <h6 className="text-secondary text-base font-normal leading-relaxed">Items
                                            Available</h6>
                                    </div>
                                </div>
                            </div>
