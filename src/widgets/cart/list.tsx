...
export const CartItem = (props: { product: ProductWithQuantity }) => {
    ...
    return (
        <>
            <div key={product.id} className="rounded-lg border border-gray-800 bg-gray-900 p-4 shadow-sm dark:bg-gray-800 md:p-6">
                <div className="space-y-4 bg-inherit md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                    ...
                    <div className="w-full min-w-0 flex-1 bg-inherit space-y-4 md:order-2 md:max-w-md">
                        <p
                            ...
                            className="text-base cursor-pointer bg-inherit font-medium text-indigo-600 hover:underline dark:text-white"
                        >
                            {product.title}
                        </p>
